<template>
  ...
  >
    ...
    >
      ...
      <div class="grid grid-cols-1 gap-6 mt-6 grid-cols-2">
        <a
          href="https://www.facebook.com/bakessbytash"
          target="_blank"
        ...
        >
          ...
          <span class="mt-2">@bakessbytash</span>
        </a>

        <a
          href="https://instagram.com/bakessbytash"
          target="_blank"
          rel="noopener noreferrer"
          class="flex flex-col items-center px-4 py-3 text-gray-700 rounded-md dark:text-gray-200"
          aria-label="Facebook"
